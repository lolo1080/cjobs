...
//Get data: country
$country = html_chars(get_get_value("country",""));
if (($country != "") && isset($jobs_in_country_info[$country])) {
	$_SESSION["globsettings"]["selected_country"] = $country;
	header("Location: ../?".$SLINE); exit;
}
...
$smarty->display('select_country.tpl');
?>