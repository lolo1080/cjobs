 ...
 * email_message.php
 *
 * @(#) $Header: /home/mlemos/cvsroot/mimemessage/email_message.php,v 1.87 2009/02/16 22:27:25 mlemos Exp $
 *
 *
 */
...
<class>
	...
	<version>@(#) $Id: email_message.php,v 1.87 2009/02/16 22:27:25 mlemos Exp $</version>
...
{metadocument}
	<variable>
		<name>mailer</name>
		<type>STRING</type>
		<value>http://www.phpclasses.org/mimemessage $Revision: 1.87 $</value>
		<documentation>
...
//		return($this->FormatHeader("Message-ID", "<".strftime("%Y%m%d%H%M%S", $seconds).substr($micros,1,5).".".ereg_replace("[^A-Za-z]", "-", $local)."@".ereg_replace("[^.A-Za-z_-]", "", $host).">"));
