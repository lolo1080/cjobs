...
require_once "mem_registration_func.php";
...
$smarty->assign("curpage","mem_registration");
...
//Create form
smarty_create_cform("frm","mainform","POST","mem_registration.php","","",5,$text_info["c_registration"],3,130,5,300,3);
