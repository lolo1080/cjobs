...
if ($change) try_change();
	...
	create_values($myrow["email"],$myrow["pass"],$myrow["company"],$myrow["name"],$myrow["phone"],$myrow["fax"],
			...
			$myrow["zipcode"],$myrow["promotioncode"],$myrow["regdate"]);
}

//Member profile page
$smarty->assign("curpage","adv_profile");

//Create line with page navigation
$smarty->assign("navwidth","10");
$smarty->assign("Pages",array(
	array("islink"=>1,"href"=>"adv_profile.php?$SLINE","text"=>$text_info["adv_profile"],"spacer"=>"")
));
...
//Create help button
smarty_create_helpbutton("adv_profile.html");

//Create form
$form_capt = $text_info["c_edit"].$text_info["adv_profile"];
smarty_create_cform("frm","mainform","POST","adv_profile.php","","",5,$form_capt,3,200,5,300,3);
