...
function save_configuration()
{
	...
	if ( $("#html_parse_regular_expression").val() != "" ) data += "&html_parse_regular_expression=" + $.URLEncode($("#html_parse_regular_expression").val());
	else { alert('Please enter Regular expression'); return; }
...
function get_field_data(el)
{
	...
	$("#selected_field_template").html('<input type="text" name="selected_field_template_text" id="selected_field_template_text" value="{*'+selval+'*}" style="width:300px;" readonly /> Replace variable part with "?" and copy to HTML field');
}
...
function check_data_parsing(btn)
{
	...
	window.open('feeds_html_check.php?cat_id='+cat_id+'&feed_id='+feed_id+'&config_id='+config_id+'&url='+$.URLEncode(url));
}
					...
					<div>
						...
						<small>
							<ul style="padding:0; padding-left:35px; margin:0;">
								...
								<li>Do not override next values: $feed_row, $log_actions, $FeedName, $url, $MainRegExpr, $Result</li>
							</ul>
						</small>
