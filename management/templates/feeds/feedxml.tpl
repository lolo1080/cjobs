...
function check_data_parsing(btn)
{
	...
	window.open('feeds_xml_check.php?cat_id='+cat_id+'&feed_id='+feed_id+'&config_id='+config_id+'&url='+$.URLEncode(url));
}
...
<form name="feed_data" action="feeds_xml.php" method="POST">
