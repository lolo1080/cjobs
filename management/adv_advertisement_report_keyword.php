...
require_once "adv_advertisement_report_keyword_func.php";
require_once "app_cache_functions.php";
check_access(array(0,1));

//Check first entry
check_first_entry("adv_advertisement_report_keyword",array("sess_aara_ad_id"));
...
$ad_id	= check_sess_id_values($ad_id,"aara_ad_id");

if (!is_this_user_current_ad($ad_id,$_SESSION["sess_userid"])) critical_error(__FILE__,__LINE__,"Access violation. Another advertiser Ad ID.");
...
$smarty->assign("DataHead", array(
	...
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","actiondate",$text_info["th_date"])),
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","clicks",$text_info["th_clicks"])),
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","adviews",$text_info["th_adviews"])),
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","ctr",$text_info["th_ctr"])),
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","avg_cpc",$text_info["th_avg_cpc"])),
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","cost",$text_info["th_cost"])),
	array("tdw"=>"75", "tdclass"=>"tbl_td_head","data"=>sort_link("adv_advertisement_report_keyword.php","avg_pos",$text_info["th_avg_pos"]))
));
...
smarty_create_filter($text_info["filter_help"],$text_info["filter"],$text_info["removefilter"],"adv_advertisement_report_keyword.php",0,$FilterElements);
...
$smarty->assign("curpage","adv_advertisement_report_keyword");
...
if ($_SESSION["sess_user"] == "0")
	$smarty->assign("Pages",array(
		...
		array("islink"=>0,"href"=>"","text"=>$text_info["adv_advertisement_report_keyword"].' ('.$ad_name_text.')',"spacer"=>"")
	));
else
	$smarty->assign("Pages",array(
		array("islink"=>1,"href"=>"adv_advertisements.php?$SLINE","text"=>$text_info["adv_advertisements"],"spacer"=>"&nbsp;&raquo;&nbsp;"),
...
smarty_create_stats_pagenavigation(false,$text_info["n_pages"],$start,$page_count,"adv_advertisement_report_keyword.php",$text_info["n_pages_from"],"",$text_info["n_go"],5,$period,$period_capt,$text_info["n_data_limit"].$text_info["n_period"],$text_info["n_from"],$date_from,$text_info["n_to"],$date_to);
if ($_SESSION["sess_user"] == "0") {
...
//Create help button
smarty_create_helpbutton("adv_advertisement_report_keyword.html");

//Create hidden values for form
$smarty->assign("fdata_action","adv_advertisement_report_keyword.php");
...
save_session_values("adv_advertisement_report_keyword");
