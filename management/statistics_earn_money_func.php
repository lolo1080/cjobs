<?
function create_values($regdate,$click_type,$keyword,$searchtype,$job_title,$amount,$email)
{
 global $smarty,$text_info,$usersettings,$payment_types;
	...
	array("flabel"=>show_cell_caption("amount",true), "before_html"=>"", "after_html"=>"", "etype"=>"text",
				"ename"=>"amount", "ereadonly"=>"readonly", "evalue"=>$amount, "emaxlength"=>"15",
				"estyle"=>"width:300px;background-color:#EEEEE9;", "isheadline"=>false, "edisabled"=>""),
	array("flabel"=>show_cell_caption("email",true), "before_html"=>"", "after_html"=>"", "etype"=>"text",
				"ename"=>"email", "ereadonly"=>"readonly", "evalue"=>$email, "emaxlength"=>"15",
				"estyle"=>"width:300px;background-color:#EEEEE9;", "isheadline"=>false, "edisabled"=>"")
	);
