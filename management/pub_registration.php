...
require_once "pub_registration_func.php";
...
$smarty->assign("curpage","pub_registration");
...
//Create form
smarty_create_cform("frm","mainform","POST","pub_registration.php","","",5,$text_info["c_registration"],3,130,5,300,3);
