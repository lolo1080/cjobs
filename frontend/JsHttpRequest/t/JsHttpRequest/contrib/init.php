...
<link rel="stylesheet" type="text/css" href="JsTest/JsTest.css?<?php=time()?>"/>
<script type="text/javascript" language="JavaScript" src="JsTest/JsTest.js?<?php=time()?>"></script>
...
<div style='clear:both; margin-bottom: 13px'>
    ...
    <a href="<?php=$_SERVER['REQUEST_URI'] . (strpos($_SERVER['REQUEST_URI'], '?')? '&' : '?') . time()?>">Refresh</a> | <a href=".">Index</a>
</div>
