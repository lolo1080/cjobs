  ...
  <td width="80%">
    ...
    <tr>
      ...
      <td valign="top" align="right">
        ...
        <div style="font-size:150%;color:#999;float:left;padding-top:30px;padding-left:50px;">Select Your Country</div>
      </td>
    </tr>
    </table>
  </td>
...
<tr>
  ...
  <td width="80%" style="line-height:105%;padding-top:10px;background-color:#f8f8f8;">
    ...
    <tr>
      <td width="5">&nbsp;</td>
      <td><img src="http://localhost/cjobs/frontend/images/coutries/us.gif" />&nbsp;<a class="toplinks" href="http://localhost/cjobs/change_country/?country=us">United States</a></td>
      <td width="250">&nbsp;</td>
      <td><img src="http://localhost/cjobs/frontend/images/coutries/ca.gif" />&nbsp;<a class="toplinks" href="http://localhost/cjobs/change_country/?country=ca">Canada</a></td>
      <td width="250">&nbsp;</td>
      <td><img src="http://localhost/cjobs/frontend/images/coutries/au.gif" />&nbsp;<a class="toplinks" href="http://localhost/cjobs/change_country/?country=au">Australia</a></td>
    </tr>
    </table>
  </td>
  <td width="10%">&nbsp;</td>
