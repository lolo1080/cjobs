...
<tr>
  <td width="10%">&nbsp;</td>
  <td width="80%" style="padding-top:10px;background-color:#f8f8f8;">
    <table width="100%">
    <tr>
      <td valign="top">
        <div align="left" style="color:#400000;font-weight:bold;font-size:95%;padding-left:0px;padding-bottom:5px;">My Jobs</div>
      </td>
    </tr>
    <tr>
      <td valign="top">
        ...
        <tr>
          <td valign="top" style="width:110px;">
            {include file="myjobs_menu.tpl"}
          </td>
          <td valign="top">
            <p>
              <div>{$ErrorMessage}</div>
            </p>
            <div>{include file="myjobs_item.tpl"}</div>
            {if $SearchJobsList}
            <div id="myjobs_bottom_navigation">
              <div>{$ShowJobsPerPage}</div>
              <div style="text-align: center">{include file="navigation.tpl"}</div>
            </div>
            {/if}
          </td>
        </tr>
